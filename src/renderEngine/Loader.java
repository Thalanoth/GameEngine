...
public class Loader {
   ...
   public int loadTexture(String fileName, String textureType) {
      Texture texture = null;
      try {
         texture = TextureLoader.getTexture("PNG", new FileInputStream
             ("res/"+textureType+"/"+fileName+".png"));
         ...
         if (GLContext.getCapabilities().GL_EXT_texture_filter_anisotropic) {
            ...
            System.out.println("anisotropic filtering not supported for you, sorry =(");
         }
   ...
   public int loadCubeMap(String[] textureFiles) {
      ...
      for (int i = 0; i < textureFiles.length; i++) {
         TextureData data = decodeTextureFile("res/skytextures/" + textureFiles[i] + ".png");
